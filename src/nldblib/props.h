...
namespace nldb
{
	...
	public:
		...
		static void set(db& db, int64_t node_id, int64_t name_string_id, int64_t value_string_id); // use < 0 to delete
		static std::unordered_map<int64_t, int64_t> get(db& db, int64_t node_id);
